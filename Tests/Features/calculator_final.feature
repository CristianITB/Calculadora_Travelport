...
Scenario Outline: Reenabling buttons with no error general case
...
Scenario Outline: Reenabling buttons with no error C button case
Given the display shows the following value: "1234567890"
When the user presses the "<button>" button
...
Scenario Outline: Reenabling buttons with no error equal button case
Given the display shows the following value: "1234567890"
When the user presses the "<button>" button
Then the "0" button should be enabled
And the "+-" button should be enabled
